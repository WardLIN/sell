<template>
	<div class="shopcart">
		...
		<div class="ball-container">
			<transition v-for="(ball,index) in balls" name="drop" tag="ul" :key="index" @beforeEnter="beforeEnter" @enter="enter" @afterEnter="afterEnter">
			...
			<div class="list-content" ref="listContent">
				<ul>
					<li class="food" v-for="food in selectFoods">
						<span calss="name">{{food.name}}</span>
						<div class="price">
